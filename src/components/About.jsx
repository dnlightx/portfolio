                ...
                >
                    ...
                    <article className="space-y-8 text-lg md:text-xl leading-relaxed text-gray-800 dark:text-gray-200">
                        ...
                        <p>
                            ...
                            Feel free to challenge me on <a href="https://www.chess.com/member/dnlight" target="_blank" rel="noopener noreferrer" className="text-[#3b82f6] dark:text-[#7fa650] font-bold hover:underline">Chess.com</a>.
                        </p>
                    </article>
